...
class Post {
    ...
    public function __construct($post) {
		...
		$content .= '<label class="tab" for="cds-seo-tab1" class="active">'.__('SEO').'</label>';
		$content .= '<input id="cds-seo-tab2" type="radio" name="tab-group" />';
		$content .= '<label class="tab" for="cds-seo-tab2">'.__('Keywords').'</label>';
		$content .= '<input id="cds-seo-tab3" type="radio" name="tab-group" />';
		$content .= '<label class="tab" for="cds-seo-tab3">'.__('Robots').'</label>';
		$content .= '<input id="cds-seo-tab4" type="radio" name="tab-group" />';
		$content .= '<label class="tab" for="cds-seo-tab4">'.__('Facebook').'</label>';
		$content .= '<input id="cds-seo-tab5" type="radio" name="tab-group" />';
		$content .= '<label class="tab" for="cds-seo-tab5">'.__('Twitter').'</label>';
		$content .= '<input id="cds-seo-tab6" type="radio" name="tab-group" />';
		$content .= '<label class="tab" for="cds-seo-tab6">'.__('Advanced').'</label>';
		...
		$content .= '<p><span id="sseo_title_count">0</span> '.__('characters. Most search engines use a maximum of 60 chars for the title.').'</p>';
		...
		$content .= '<p><span id="sseo_desc_count">0</span> '.__('characters. Most search engines use a maximum of 160 chars for the description.').'</p>';
		...
		$content .= __('<p>A comma separated list of your most important keywords for this page that will be written as META keywords.</p>');
		...
		$content .= __('<p>This is the title shared on Facebook, if left blank the default title for the post will be used.</p>');
		...
		$content .= '<p>'.__('This is the description shared on Facebook, if left blank the default description for the post will be used.').'</p>';
		...
		<input type="button" class="button-primary sseo-media-button" value="'.__('Select an Image').'" id="sseo_fb_media_manager"/>
		<input type="button" class="button-primary sseo-media-button" value="'.__('Remove Image').'" id="sseo-fb-media-remove"/>';

		$content .= '<p>'.__('If you want to override the image used on Facebook for this post, upload / choose an image here. The recommended image size for Facebook is 1200 by 630 pixels.').'</p>';
		...
		$content .= '<p>'.__('This is the title shared on Twitter, if left blank the default title for the post will be used.').'</p>';
		...
		$content .= '<p>'.__('This is the description shared on Twitter, if left blank the default description for the post will be used.').'</p>';
		...
		<input type="button" class="button-primary sseo-media-button" value="'.__('Select an Image').'" id="sseo_tw_media_manager"/>
		<input type="button" class="button-primary sseo-media-button" value="'.__('Remove Image').'" id="sseo-tw-media-remove"/>';

		$content .= '<p>'.__('If you want to override the image used on Twitter for this post, upload / choose an image here. The recommended image size for Twitter is 1024 by 512 pixels.').'</p>';
